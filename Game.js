...
class Game {
    ...
    questionSetter() {
        if (this.questionCounter === 0) {
            ...
            this.messageArea = new TypeIt(".messagearea", { speed: 50 })
                .pause(2000)
                .type(
                    "Get ready for your first question, which is worth a whopping 500 munnys."
                )
                .pause(500)
                .delete()
            ...
            this.messageArea = new TypeIt(".messagearea", { speed: 50 })
                ...
                .delete()
                .type(
                    `And here is the question for ${
                        this.scoreBoard.scores[this.questionCounter]
                    } Munnys`
                )
                .pause(1000)
                .delete()
    ...
    paf() {
        this.messageArea = new TypeIt(".messagearea", { speed: 50 })
            ...
            .delete()
            .type(
                "Hello, yes this is Monopoly man and we're currently playing Who wants to be a Munnyaire."
            )
            .pause(500)
            .delete()
            .type(
                `Yes the current question is for ${
                    this.scoreBoard.scores[this.questionCounter]
                } munnys.`
            )
            .pause(1000)
            ...
            .pause(2500)
            .type(
                `${this.selectedPerson} thinks the answer is ${this.currentCorrectAnswer}.`
            )
            .exec(() => {
                if (this.questionCounter <= 4) {
                    this.startTimer();
